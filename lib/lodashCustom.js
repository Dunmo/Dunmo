...
_.renamedProp = (object, oldKey, newKey) => {
  if(typeof object !== Object
  || typeof oldKey !== String || typeof newKey !== String) {
    return object
  }
  object = _.cloneDeep(object);
  if (oldKey !== newKey) {
    let oldDescriptor = Object.getOwnPropertyDescriptor(object, oldKey);
    Object.defineProperty(object, newKey, oldDescriptor);
