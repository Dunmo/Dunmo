...
Natural = {
  ...
  parseDueAt: function(str) {
    ...
    if ( date.isValid() ) return [temp.trim(), date];
  ...
  parseDuration: function(str) {
    ...
    if(i == match.length) return [str.trim(), dur];
  ...
  parseTitle: function (str) {
    ...
    var due = this.parseDueAt(imp[0]);
    var duration = this.parseDuration(due[0]);
  ...
  parseTask: function (str) {
    ...
    console.log("parseTask input str: ", str);
